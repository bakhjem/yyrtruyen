...
(function (e, t, n) {
    ...
    o.prototype.init = function () {
        ...
        /*
        name_href = document.getElementById('logo').href;
        name_logo = document.getElementById('logo').innerHTML;
        string_name_logo = "<a rel=\"nofollow\" href=\"" + name_href + "\" class=\"logo_menu\">" + name_logo + "</a>";
        n.btn = e([string_name_logo + "<" + i.parentTag + ' aria-haspopup="true" tabindex="0" class="' + s + "_btn " + s + '_collapsed">', '<span class="' + s + '_menutxt">' + i.label + "</span>", '<span class="' + o + '">', '<span class="' + s + '_icon-bar"></span>', '<span class="' + s + '_icon-bar"></span>', '<span class="' + s + '_icon-bar"></span>', "</span>", "</" + i.parentTag + ">"].join(""));
        */
        ...
        e(a)
            .each(function () {
                ...
                if (r.children.length > 0) {
                    ...
                    if (i.allowParentLinks && !i.nestedParentLinks && u) l = l.wrap(a)
                        .parent();
                    e(nodes)
                        .last()
                        .after(l)
                ...
                if (i.closeOnClick && i.allowParentLinks) {
                    ...
                    t.find("." + s + "_parent-link a:not(." + s + "_item)")
                        .click(function (t) {
                            e(n.btn)
                                .click()
                        })
